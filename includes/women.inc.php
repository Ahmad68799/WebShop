    ...
    <div class="men-collection">
        ...
        <div class="content">
            ...
            <aside class="men-list">
                <h1>Categories:</h1>
                <?php
                $stmt = $pdo->prepare("SELECT * FROM subcategories WHERE main_categorie_id = 5");
                $stmt->execute();
                $result = $stmt->fetchAll(PDO::FETCH_ASSOC);
                foreach ($result as $categorie) {
                    echo '
                            <ul>
                                <li><a href="index.php?page=women&subcategorie_id=' . htmlspecialchars($categorie['subcategorie_id']) . '">' . htmlspecialchars($categorie['name']) . '</a></li>
                           </ul>
                        ';
                }
                ?>
            ...
            <div class="product-grid1">
                ...
                $query =("
                        ...
                        WHERE subcategories.main_categorie_id = 5 
                    ");

                if ($subcategorie_id && $subcategorie_id != 5) {
